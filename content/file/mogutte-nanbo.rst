...
.. container:: gallery
   ...
   .. figure:: {static}mogutte-nanbo/menu.png
      :alt: Mogutte Nanbo main menu

      Main menu

   .. figure:: {static}mogutte-nanbo/characters.png
      :alt: Character intro
   ...
   .. figure:: {static}mogutte-nanbo/end.png
      :alt: Mogutte Nanbo game-over screen

      Game-over screen

   .. figure:: {static}mogutte-nanbo/island.png
      :alt: Island graphics

      Island graphics

   .. figure:: {static}mogutte-nanbo/sezaki.png
      :alt: Sezaki graphics
