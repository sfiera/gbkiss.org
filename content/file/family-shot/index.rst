...
Family Shot connects to the `Game Boy Printer`_ and prints a photo of the current residents of the player’s house in `Pocket Family GB`_. There are three options:
...
.. container:: gallery
   ...
   .. figure:: {static}print.png
      :alt: Printed photo with date and time
      :width: 160
      :height: 144

      Printed photo with date and time

   .. figure:: {static}hudson.png
      :alt: Printed photo with Hudson Soft copyright
      :width: 160
      :height: 144

      Printed photo with Hudson Soft copyright
